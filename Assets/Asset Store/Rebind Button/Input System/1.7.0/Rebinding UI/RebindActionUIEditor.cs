...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            m_ActionOverrideProperty = serializedObject.FindProperty("m_ActionOverride");
            m_ActionOverrideStringProperty = serializedObject.FindProperty("m_ActionOverrideString");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                if (m_RebindActionUI.m_ActionOverride)
                {
        ...
        private GUIContent m_customActionLabel = new GUIContent("Custom Action");
